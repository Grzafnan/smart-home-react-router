  ...
  return (
    <footer className="footer-wrapper">
      ...
      <div className="py-6 text-sm text-center text-gray-400">
        © {year} Smart Home Inc By <a href="https://www.linkedin.com/in/grzafnan/" target='blank' className="italic text-gray-500 font-semibold hover:text-gray-900">Shakil Ahmmed</a>.  All rights reserved.
      </div>
    </footer>
  );
};
